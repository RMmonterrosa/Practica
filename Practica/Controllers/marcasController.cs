...
namespace Practica.Controllers
{
    public class marcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_marcas,nombre,estados")] marcas marcas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_marcas,nombre,estados")] marcas marcas)
        {
